...
- I submitted a [bot](https://github.com/schmit/halite-bot) to the [Halite](http://halite.io) AI competition which finished in the top 3%.

- I have collected some Jupyter notebooks for fun little projects on [github](https://github.com/schmit/fun-notebooks).
   ...
   to help me fill out my March Madness bracket by modeling game outcomes using Stan.
