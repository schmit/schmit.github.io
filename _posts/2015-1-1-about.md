...
My research focuses on how human interaction with learning systems affects outcomes and
...
- **Stitch Fix**, 2018 - Now
    ...
    On the Algorithms team at Stitch Fix I have worked on a variety of machine learning, statistics and opimtization. These include:
    an experimentation framework to deal with spillover effects from inventory constraints, multiple algorithms based on latent embeddings: similar item search, diversifying recommendations, and generating outfits, solving large scale optimization problems (distributed in PySpark, and with state of the art commercial solver), creating a production system that serves style shuffle quizzes to clients in real-time, and creating / running / analyzing multiple experiments.
